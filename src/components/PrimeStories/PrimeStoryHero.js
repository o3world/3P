...
class PrimeStoryHero extends Component {
    render() {
        const storyStyle = {
            backgroundImage: "url(" + this.props.featured_image_wide + ")"
        };
        return (
            <div className={this.props.storyClass}>
                <img src={this.props.featured_image_wide} style={storyStyle} alt={'add alt'} className="prime-story-hero__image"/>
