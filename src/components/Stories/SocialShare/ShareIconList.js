...
const ShareIconList = (props) => 
  <div className={styles.socialIcons}>
    <a target='_blank' rel="noopener noreferrer" href={`mailto:?subject=TriplePundit.com: ${props.title}&body=${props.description}%0D%0A%0D%0A${props.url}`}><FontAwesomeIcon icon={['fas', 'envelope']} /></a>
