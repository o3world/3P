...
const ShareIconList = (props) => 
  <div className={styles.socialIcons}>
    ...
    <a target='_blank' rel="noopener noreferrer" href={`https://twitter.com/intent/tweet?url=${props.url}&text=${props.title}&via=triplepundit`}><FontAwesomeIcon icon={['fab', 'twitter']} /></a>
